        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Died = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterOffices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CharacterOffices_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterOffices_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterOffices_CharacterId",
                table: "CharacterOffices",
                column: "CharacterId");

            migrationBuilder.CreateIndex(
                name: "IX_CharacterOffices_OfficeId",
                table: "CharacterOffices",
                column: "OfficeId");

            migrationBuilder.CreateIndex(
                name: "IX_Offices_NormalizedTitle",
                table: "Offices",
